...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="min-h-screen flex flex-col bg-white border-t border-black/8 overflow-hidden">
      ...
      <div className="flex-shrink-0 pt-[60px] pb-12 lg:pb-16 px-5 lg:px-8 border-b border-black/8 flex items-end justify-between">
        ...
        <motion.p
          ...
          className="body-label max-w-[220px] text-right hidden lg:block"
        >
      ...
      {/* Content grid: flex-1 */}
      <div className="flex-1 grid lg:grid-cols-2 border-b border-black/8">
        {/* Left: contact info */}
        <motion.div
        ...
        >
          <div className="space-y-10">
            {[
              ...
              <div key={item.l}>
                <div className="body-label mb-3 text-[#C6A36A]">{item.l}</div>
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-[#0A0A0A] text-white px-6 py-4 body-label font-semibold hover:bg-[#C6A36A] transition-colors duration-300 self-start w-full sm:w-auto justify-center sm:justify-start"
          >
        ...
        >
          <div className="space-y-8">
            {[
              ...
              <div key={f.n} className="border-b border-black/10 pb-5 group focus-within:border-[#C6A36A] transition-colors duration-300">
                <label className="body-label block mb-4 text-[#C6A36A]">{f.l}</label>
          ...
          <button type="submit"
            className="w-full bg-[#0A0A0A] text-white body-label font-semibold py-5 hover:bg-[#C6A36A] transition-colors duration-300 mt-8">
