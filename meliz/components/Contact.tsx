    ...
    <section id="contact" ref={ref} className="bg-white border-t border-black/8 overflow-hidden">
      ...
      <div className="grid lg:grid-cols-2 border-b border-black/8">
        ...
        <motion.div
          ...
          className="px-5 lg:px-8 py-20 lg:py-32 border-b lg:border-b-0 lg:border-r border-black/8"
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-[#0A0A0A] text-white px-8 py-5 body-label font-semibold hover:bg-[#C6A36A] transition-colors duration-300"
          >
        ...
        <motion.form
          ...
          className="px-5 lg:px-8 py-20 lg:py-32 space-y-10"
        >
          {[
          ...
          <button type="submit"
            className="w-full bg-[#0A0A0A] text-white body-label font-semibold py-5 hover:bg-[#C6A36A] transition-colors duration-300">
